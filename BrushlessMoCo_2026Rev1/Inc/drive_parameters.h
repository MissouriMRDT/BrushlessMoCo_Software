...
#define SW_DEADTIME_NS                      175 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KP_DEFAULT               3520
#define PID_TORQUE_KI_DEFAULT               2298
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3520
#define PID_FLUX_KI_DEFAULT                 2298
...
#define PID_SPEED_KP_DEFAULT                2967/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                6/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define UD_VOLTAGE_THRESHOLD_V              3 /*!< Under-voltage threshold */
